...
public class LSH_SceneChanger2 : MonoBehaviour
{

    private GameObject Scene1_EventBtn;             //왼쪽위의 선물상자 버튼
    [SerializeField] GameObject Scene1_EventCanvas; //위의 버튼 누르면 튀어나올 유아이
    //private GameObject Scene2_Btn1;           //가로로 넓은 1개짜리 버튼
    //private GameObject Scene2_Btn2;           //나열된 3개짜리 버튼 중 왼쪽
    //private GameObject Scene2_Btn3;           //나열된 3개짜리 버튼 중 중간
    //private GameObject Scene2_Btn4;           //나열된 3개짜리 버튼 중 오른쪽
